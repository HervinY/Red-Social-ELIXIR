defmodule RedSocial.AccountsTest do
  use RedSocial.DataCase
  ...
  describe "users" do
    ...
    test "create_user/1 with valid data creates a user" do
      valid_attrs = %{name: "some name", type: "some type", username: "some username", email: "some email", bio: "some bio"}
