      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="p-6 border-b border-gray-100 bg-gray-50">
              <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
                <.icon name="hero-chart-bar" class="w-5 h-5 text-blue-600" /> Analytics
              </h2>
            </div>
          ...
          <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="p-6 border-b border-gray-100 bg-gray-50">
              <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
                <.icon name="hero-user-group" class="w-5 h-5 text-green-600" /> Simulation
              </h2>
            </div>
            ...
            <div class="p-6">
              <div class="mb-6">
                ...
                <form phx-change="select_user">
                  <select
                    name="user_id"
                    class="w-full rounded-lg border-2 border-gray-300 bg-white text-gray-900 px-4 py-2.5 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 font-medium"
                  >
