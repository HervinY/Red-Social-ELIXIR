defmodule RedSocialWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RedSocialWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RedSocialWeb.Gettext, "errors", msg, opts)
    end
  end
